                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    <br />
                                    <form action="<?=base_url()?>index.php/admin/edit_news/<?=$news->id?>/<?=$news->image?>" method="POST" enctype="multipart/form-data" role="form" class="form-horizontal form-label-left">
                                        <div class="form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">News Title<span class="required">*</span>
                                            </label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input type="text" required class="form-control col-md-7 col-xs-12" name="title" value="<?=$news->title?>">                                    </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                 <textarea required class="form-control col-md-7 col-xs-12" name="description"><?=$news->description?></textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group" >
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                               <img id="output_image" style="max-width:350px;" src="<?=base_url('uploads/news_image/'.$news->image.'')?>">
                                            </div>
                                        </div>
                                        <!-- image preview -->
                                         <div class="form-group">
