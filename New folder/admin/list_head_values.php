...
<div class="right_col" role="main">
        ...
        <tbody>
          ...
          <tr class="even pointer">
            ...
            <td class=" last"><a class="btn btn-info btn-xs" href="<?=base_url()?>index.php/admin/edit_head_value/<?=$row->id?>"><i class="fa fa-pencil">Edit</i></a>&nbsp; <a class="btn btn-danger btn-xs" href="<?=base_url()?>index.php/admin/delete_head_value/<?=$row->id?>" onclick="return confirm('Are you sure, wants to delete?')" ><i class="fa fa-ban">Delete</i></a> </td>
          </tr>
          <?php $i++; } ?>
        </tbody>
      </table>
