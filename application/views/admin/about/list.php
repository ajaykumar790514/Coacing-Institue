<div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">About List</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
                                    ...
                                    <tr class="">
                                        ...
                                        <td><?=$row->title?></td>
                                        <td><?=$row->url?></td>
                                        <td><img style="width: 100px" src="<?=base_url()?>images/about/<?=$row->image?>"></td>
                                        ...
                                        <td>
                                            <a href="<?=base_url()?>index.php/admin/edit_about_page/<?=$row->id?>" class="btn btn-warning" title="EDIT">
                                        ...
                                        <td>
                                             <button class="btn btn-info" data-toggle="modal" data-target="#myModal" onclick="about_page_detail(<?=$row->id?>)"><i class="fa fa-info"></i></button>
                                        </td>
                                    </tr>
                                    <?php $i++; } ?>
                                </tbody>
        ...
        <script type="text/javascript">
            function about_page_detail(id)
            {
                $("#p_d").html('<h3 style="color:red">Loading....</h3>');
                $("#p_d").load('<?=base_url()?>index.php/admin/about_page_detail/'+id);
            }
    ...
    <div class="modal-dialog modal-lg">
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title">About Page Details..</h4>
        </div>
        <div class="modal-body" id="p_d">
          <p>Some text in the modal.</p>
        </div>
        <div class="modal-footer">
            <a href="<?=base_url()?>index.php/admin/edit_about_page/<?=$row->id?>" class="btn btn-warning" title="EDIT" style=''>
              <i class="fa fa-edit"></i>
            </a>
