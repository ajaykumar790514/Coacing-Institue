<div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Add Key Achievement</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
            ...
            <div class="row well">
                ...
                <div class="col-lg-6">
                                    <form role="form" action="<?=base_url()?>index.php/admin/add_achievement" method="post"  enctype='multipart/form-data'>
                                        <div class="form-group">
                                            <label>Year</label><span style="color:red">*</span>
                                            <input class="form-control" type="number" name="year"   placeholder="YYYY"   required min="2014" max="<?php echo date("Y");?>"  >
                                            <p class="help-block"></p>
                                        </div>

                                        <div class="form-group">
                                            <label>Rank</label><span style="color:red">*</span>
                                            <input class="form-control" name="title"  onchange="cr_url(this.value)">
                                            <p class="help-block"></p>
                                        </div>
    ...
    function get_cities(state_id) 
    {
        ...
        $("#cities").load('<?=base_url()?>index.php/admin/get_cities/'+state_id);
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea id="markItUp" rows="8" class="form-control" name="testimonial"></textarea>
                                            <p class="help-block"></p>
                                        </div>
