<div id="page-wrapper">
            ...
            <div class="row well">
                ...
                <div class="col-lg-6">
                                    <form role="form" action="<?=base_url()?>index.php/admin/edit_achievement_type/<?=$achiv_type->id?>" enctype="multipart/form-data" method="post">
                                         <div class="form-group">
                                            <label>Title<span style="color: red;">*</span><p id="aa"></p> </label>
                                            <input type="text" id="title" class="form-control" name="title" required onkeyup="check_achiev_type()" value="<?=$achiv_type->title?>">
                           ...
                           $("#aa").html('<span style="color:;"></span>');
                            $("#submitbtn").removeClass("disabled");
                                       ...
                                       <!--  <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="desc" value="<?=$achiv_type->desc?>">
                                            <p class="help-block"></p>
                                        </div> -->
