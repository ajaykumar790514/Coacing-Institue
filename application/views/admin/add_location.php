                ...
                <div class="">
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="x_panel">
                                <div class="x_title">
                                    <h2>Add Location<small>add here..</small></h2>
                                    <a style="float:right" href="<?=base_url()?>index.php/admin/list_locations" class="btn btn-info">LIST</a>
                                    <div class="clearfix"></div>
                                </div>
                                <div class="x_content">
                                    <br />
                                    <form action="<?=base_url()?>index.php/admin/add_location" method="POST" enctype="multipart/form-data" role="form" class="form-horizontal form-label-left">
