<div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Edit Attribute Group</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
            ...
            <div class="row well">
                ...
                <div class="col-lg-6">
                                    <form role="form" action="<?=base_url()?>index.php/admin/edit_attribute_group/<?=$att->id?>" method="post">
                                        <div class="form-group">
                                            <label>Group Name</label><span style="color:red">*</span>
                                            <input class="form-control" name="name" required="" value="<?=$att->name?>">
                                            <p class="help-block"></p>
                                        </div>

                                        <div class="form-group">
                                            <label>Description</label>
                                            <textarea id="markItUp" rows="8" class="form-control" name="description"><?=$att->description?></textarea>
                                            <p class="help-block"></p>
                                        </div>
