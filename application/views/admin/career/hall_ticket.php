...
<?php
	...
	?>
<center>
<body id="printableArea" class="watermark">
<div class="row">
	...
	<div class="container">
		<div class=" container hall_ticket">
			<div class="iimmgg">
			 ...
			 <img class="img-responsive"  src="<?=base_url()?>image/hall_ticket_logo.PNG">
			</div>
			<div class="col-md-12 text-center title">
				JEE EXPERT ADMISSION TEST- 2019-20<br>HALL TICKET
			</div>
			...
			<input class="printBtn" id="printpagebutton" type="button" onclick="printdiv('printableArea')" value="print" />
		</div>
	</div>
</div>
<style type="text/css">
...
<script type="text/javascript">
	...
	{
		$('#printpagebutton').addClass('hidden');
