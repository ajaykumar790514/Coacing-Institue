<div id="page-wrapper">
            ...
            <div class="row well">
                ...
                <div class="col-lg-6">
                                    <form role="form" action="<?=base_url()?>index.php/admin/add_contact?>" method="post">
                                        ...
                                        <div class="form-group">
                                            <label>Address</label>
                                            <textarea id="markItUp" rows="8" class="form-control" name="address" onchange="extract_keywords()"></textarea>
                                            <p class="help-block"></p>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea rows="8" class="form-control" name="map_location"></textarea>
                                            <p class="help-block"></p>
                                            <!-- <a class="btn btn-success" href="javascript:void(0)" onclick="extract_keywords()">Extract Keywords</a><br><br><br> -->
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea rows="8" class="form-control" name="meta_description" id="meta_description"></textarea>
                                            <p class="help-block"></p>
                                        </div>
