<div id="page-wrapper">
            ...
            <div class="row well">
                ...
                <div class="col-lg-6">
                                    <form role="form" action="<?=base_url()?>index.php/admin/edit_contact/<?=$contact->id?>" method="post">
                                        
                                        <div class="form-group">
                                            <label>Title</label>
                                            <textarea  rows="2" class="form-control" name="title" ><?=$contact->title?></textarea>
                                        ...
                                        <div class="form-group">
                                            <label>Address</label>
                                            <textarea id="markItUp" rows="8" class="form-control" name="address" onchange="extract_keywords()"><?=$contact->address?></textarea>
                                            <p class="help-block"></p>
                                        ...
                                        <div class="form-group">
                                           ...
                                           class="form-control" value="<?=$contact->website?>">
                                            <p class="help-block"></p>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea rows="8" class="form-control" name="map_location"><?=$contact->map_location?></textarea>
                                            <p class="help-block"></p>
                                            <!-- <a class="btn btn-success" href="javascript:void(0)" onclick="extract_keywords()">Extract Keywords</a><br><br><br> -->
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <label>Fax</label>
                                            <input class="form-control" name="fax" value="<?=$contact->fax?>">
                                            <p class="help-block"></p>
                                        </div>

                                        <div class="form-group">
                                            <label>Meta Title</label>
                                            <input class="form-control" name="meta_title" value="<?=$contact->meta_title?>">
                                            <p class="help-block"></p>
                                        </div>

                                        <div class="form-group">
                                            <label>Meta Description</label>
                                            <textarea rows="8" class="form-control" name="meta_description" id="meta_description"><?=$contact->meta_description?></textarea>
                                            <p class="help-block"></p>
                                        </div>

                                        <div class="form-group">
                                            <label>Meta Keywords</label>
                                            <textarea id="meta_keywords" rows="8" class="form-control" name="meta_keywords"><?=$contact->meta_keywords?></textarea>
                                            <p class="help-block"></p>
                                        </div>
