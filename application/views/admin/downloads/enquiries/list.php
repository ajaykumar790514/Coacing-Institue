                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
                                    <?php $i=1; foreach($enquiry->result() as $row){ ?>
                                    <tr class="">
                                        <td><?=$i?></td>
                                        <td><?=$row->name?></td>
                                        <td><?=$row->email?></td>
                                        ...
                                        <td>
                                          ...
                                          $n=1;
                                          foreach ($str as $s) {
                                            $head_v=$this->admin_model->get_head_value_data($s);
                                            $head = $this->admin_model->get_heads($head_v->head_id);
                                            echo "<b>".$n."</b>. ".$head->head_name."&nbsp; - &nbsp;".$head_v->value."<br>";
                                         $n++; }
										  }
                                          ?>
                                        </td>
