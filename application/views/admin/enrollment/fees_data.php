...
<!-- <input type="hidden" name="" id="add_Scholarship" value="<?//=$add_Scholarship?>"> -->
<!-- <input type="hidden" name="" id="add_Scholarship_reason" value="<?//=$add_Scholarship_reason?>"> -->
 </td> 
</tr>
...
$(document).ready(function(){
  $('#submit').click(function(){
    ...
    // var add_Scholarship = $('#add_Scholarship').val();
    // var add_Scholarship_reason = $('#add_Scholarship_reason').val();
    var i; var n=0;
    for (i = 1; i <= ROWSs; i++) { 
     ...
     var SendData = {academic_year:academic_year,fees_amount:fees_amount,payment_date:payment_date,gst_rate:gst_rate,gst_comp:gst_comp,scholarship:Scholarship,fee_plan:fee_plan,fee_index:fee_index,total_fee:total_fee,due:due,discount:discount};
      ...
      $.ajax({
        type: 'POST', url:'<?=base_url()?>enrollment/assign_fees/<?=$student->stu_id?>', data:SendData,
