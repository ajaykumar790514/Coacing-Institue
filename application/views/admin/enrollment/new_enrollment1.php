...
<script type="text/javascript">
  function load_batch(program_id)
  {
    ...
    $.ajax({
        url: '<?=base_url()?>enrollment/get_enrollment',
        method: 'POST',
        data: {
            class_id: CLASS,
        ...
        success: function(response) {
            ...
            if(response.success)
            {
              $('.enrollment_no').val(response.code);
            }
        },
...
<form method="post" id="add_form" action="<?=base_url()?>enrollment/enrollment_submit">          
<br><br>
      ...
      <div class="form-group">
        ...
        <div class="col-md-6 col-sm-12">
            <div class="input-group">
              ...
              <input class="form-control enrollment_no" id="enrol" type="text" aria-describedby="namestudent" placeholder="Student Enrollment No."   name="enrol" readonly required>
        ...
        <div class="form-row">
          <div class="col-md-4 col-sm-12">
            <div class="input-group">
              ...
              <select class="form-control" id="stu_class" name="stu_class" onchange="get_program(this.value)"  required="">
                <option value="">-- Select Class --</option>
                <?php foreach($classes as $class):?>
                  <option value="<?php echo $class->class;?>"><?php echo $class->class;?></option>
                  <?php endforeach?>
              </select>
              <!-- <input class="form-control" type="text"  placeholder="Class"  name="stu_class" id="stu_class"  oninput="get_program(this.value)"  required> -->
            </div>
          </div>
          <div class="col-md-4 col-sm-12">
            <div class="input-group">
              <span class="input-group-addon" style="color:darkblue;"><b>d) Program : *</b></span>
              <select class="form-control" id="program" name="program" onchange="load_batch(this.value)"  required="">
      ...
      <div class="form-group">
        <div class="form-row">
          <div class="col-md-12">
            ...
            <input class="form-control" id="date" type="date"  placeholder="Enter dob"   name="dob"  >
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="form-group">
        <div class="form-row">
          <div class="col-md-12">
            ...
            <input class="form-control" id="email" type="email" aria-describedby="date" placeholder="Enter Email"   name="email" >
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="form-group">
        <div class="form-row">
          <div class="col-md-12">
            ...
            <input class="form-control" type="text"  placeholder="Enter Aadhar Number"  name="adhar_number">
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="form-row">
          <div class="col-md-12">
            <div class="input-group">
              ...
              <input class="form-control" id="mobile_no" type="text" aria-describedby="namestudent" placeholder="Student Mobile No."   name="mobile_no" required>
              <div id="errMessage" style="color: red;"></div>
            </div>
          </div>
        </div>
        ...
        <div class="form-row">
          <div class="col-md-6">
            <div class="input-group">
              ...
              <select class="form-control" id="state" name="state" onchange="load_city(this.value)" >
        ...
        <div class="form-row">
          <div class="col-md-12">
            <div class="input-group">
              ...
              <textarea class="form-control" row="17" id="date" type="address" aria-describedby="date" placeholder="Enter Address"  name="address"></textarea>
            </div>
          </div>
        ...
        <div class="form-row">
          <div class="col-md-12">
            <div class="input-group">
              ...
              <input class="form-control"  type="number"  placeholder="Pincode."   name="pin" id="pin" >
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="form-row">
          <div class="col-md-12">
            <div class="input-group">
              ...
              <input class="form-control" id="school" type="text"  placeholder="School Name"  name="school" >
            </div>
          </div>
        </div>
      </div>
          ...
          <table class="table table-bordered  ">
                        ...
                        <tbody>
                            <tr class="table-info">
                                ...
                                <td>
                                  <input class="form-control father_name" type="text" name="father_name" placeholder="Enter Here"  onkeyup="this.value = this.value.toUpperCase();" >
                                </td>
                                <td>
                                  <input class="form-control mother_name" type="text" name="mother_name" placeholder="Enter Here"  onkeyup="this.value = this.value.toUpperCase();"  >
                                </td>
                            </tr>
              <tr>
                               <td style="color:darkblue;" >Qualification</td>
                               <td>
                                  <input class="form-control father_name" type="text" name="father_qualification" placeholder="Enter Here">
                               </td>
                               <td>
                                  <input class="form-control mother_name" type="text" name="mother_qualification" placeholder="Enter Here">
                               </td>
                            </tr>
              <tr class="table-info" >
                               <td style="color:darkblue;">Occupation</td>
                               <td>
                                  <input class="form-control father_name" type="text" name="father_occupation" placeholder="Enter Here"  >
                               </td>
                               <td>
                                  <input class="form-control mother_name" type="text" name="mother_occupation" placeholder="Enter Here"  >
                               </td>
                            </tr>
              <tr>
                               <td style="color:darkblue;" >Organization Name</td>
                               <td>
                                  <input class="form-control father_name" type="text" name="father_organization" placeholder="Enter Here" >
                               </td>
                               <td>
                                  <input class="form-control mother_name" type="text" name="mother_organization" placeholder="Enter Here" >
                               </td>
                            </tr>
              <tr class="table-info">
                               <td style="color:darkblue;">Designation in Organization</td>
                               <td>
                                  <input class="form-control father_name"  type="text" name="father_designation_in_organization" placeholder="Enter Here" >
                               </td>
                               <td>
                                  <input class="form-control mother_name" type="text" name="mother_designation_in_organization" placeholder="Enter Here" >
                               </td>
                            </tr>
              <tr>
                               <td style="color:darkblue;">Contact No. : </td>
                               <td>
                                  <input class="form-control father_name" type="text" name="father_contact_no" placeholder="Enter Here"   >
                               </td>
                               <td>
                                  <input class="form-control mother_name" type="text" name="mother_contact_no" placeholder="Enter Here"  >
                               </td>
                            </tr>
                            <tr>
                               <td style="color:darkblue;">Email Id. : </td>
                               <td>
                                  <input class="form-control father_name" type="email" name="father_email" placeholder="Enter Here"  >
                               </td>
                               <td>
                                  <input class="form-control mother_name" type="email" name="mother_email" placeholder="Enter Here" >
                               </td>
                            </tr>
                        </tbody>
                    </table>
