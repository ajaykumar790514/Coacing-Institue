<div id="page-wrapper">
          ...
          .panel-heading { padding-bottom: 15px; }
            ...
            <a class="btn btn-warning btn-xs add-btn" href="/admin/add_event" ><i class="fa fa-plus"></i> Add</a>
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
                                    <?php $i=1; foreach($events->result() as $product){ ?>
                                    <tr class="">
                                        <td><?=$i?></td>
                                        <td><?=$product->name?></td>
                                        ...
                                        <td>
                                            <a href="<?=base_url()?>index.php/admin/edit_event/<?=$product->id?>" class="btn btn-warning">
        ...
        <script type="text/javascript">
            ...
            function product_images(id)
            {
                ...
                $("#p_i").load('<?=base_url()?>index.php/admin/event_images/'+id);
            }
            ...
            function activate_inactive(id,status)
            {
                ...
                $("#active_status"+id).load('<?=base_url()?>index.php/admin/active_inactive_attribute_group/'+id+'/'+status);
            }
        </script>
