<div id="page-wrapper">
            ...
            <a style="float:right" class="btn btn-info" href="<?=base_url()?>index.php/admin/faq_list">LIST FAQS</a>
            <div class="row well">
                <h5 style="color:red;"><strong>* Please Fill All Mendatory Fields</strong></h5><br>
                <div class="col-lg-6">
                                    <form role="form" action="<?=base_url()?>index.php/admin/add_faq" method="post">
                                        

                                        <div class="form-group">
                                            <label>Question</label>
                                            <textarea rows="4" id="markItUp" class="form-control" name="question"></textarea>
                                            <p class="help-block"></p>
                                        </div>

                                        <div class="form-group">
                                            <label>Answer</label>
                                            <textarea rows="8" id="markItUp1" class="form-control" name="answer"></textarea>
                                            <p class="help-block"></p>
                                        </div>
