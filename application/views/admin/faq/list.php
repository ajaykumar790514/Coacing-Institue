<div id="page-wrapper">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <a class="btn btn-warning" style="float: right" href="<?=base_url()?>index.php/admin/add_faq">Add <i class="fa fa-plus-circle"></i></a>
                        ...
                        <div class="panel-body">
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
                                    <?php $i=1; foreach($faqs->result() as $product){ ?>
                                    <tr class="">
                                        <td><?=$i?></td>
                                        ...
                                        <td>
                                            <a href="<?=base_url()?>index.php/admin/edit_faq/<?=$product->id?>" class="btn btn-warning">
                                                <i class="fa fa-edit"></i>
                                            </a>
                                            <a href="<?=base_url()?>index.php/admin/delete_faq/<?=$product->id?>" class="btn btn-danger" onclick="return confirm('Are you sure, you want to delete?')">
        ...
        <script type="text/javascript">
            ...
            function activate_inactive(id,status)
            {
                ...
                $("#active_status"+id).load('<?=base_url()?>index.php/admin/active_inactive_faq/'+id+'/'+status);
            }
        </script>
