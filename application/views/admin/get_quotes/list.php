<div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Quotes List</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                <thead>
                                    <tr>
                                        ...
                                        <th>Email</th>
                                        <th>Products</th>
                                        <th>Date & Time<br>(y-m-d h:m:s)</th>
                                       <!--  <th>Reply Status</th> -->
                                        
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php $i=1; foreach($quotes->result() as $product){ ?>
                                    <tr class="">
                                        <td><?=$i?></td>
                                        ...
                                        <td><?=$product->email?></td>
                                        <td><?php
                                        $p=explode(",",$product->products);
                                          $n=1;
                                        foreach ($p as $pro) {
                                          $this->load->model('admin_model');
                       $product_name=$this->admin_model->get_products_name($pro);
                                                  echo $n ."&nbsp;-&nbsp;". $product_name->name."<br>"; 
                                             $n++; }                                      
                                          ?>
                                          </td>

                                        <td><?=$product->date_time?></td>
                                       <!--  <td><?=$product->reply_status?></td> -->
