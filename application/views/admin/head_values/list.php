<div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Heads Value List</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
                                    <?php $i=1; foreach($head_values->result() as $row){ ?>
                                    <tr class="">
                                        <td><?=$i?></td>
                                        <td><?=$row->head_name?></td>
                                        <td><?=$row->value?></td>
                                       <td>
                                            <a class="btn btn-info btn-xs" href="<?=base_url()?>index.php/admin/edit_head_value/<?=$row->id?>"><i class="fa fa-pencil">Edit</i></a>
                                            &nbsp; <a class="btn btn-info btn-xs" href="<?=base_url()?>index.php/admin/delete_head_value/<?=$row->id?>" onclick="return confirm('Are you sure, wants to delete?')" ><i class="fa fa-ban">Delete</i></a>
