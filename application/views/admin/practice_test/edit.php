<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Update Practice-Test</h1>
        </div>
    </div>
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                   ...
                   <a style="float: right" class="btn btn-info btn-xs" href="<?=base_url()?>result_master/practice_test_list">
                        <i class="fa fa-list"></i> LIST
                    </a>
                </div>
                <div class="panel-body">
                <h5 style="color:red;"><strong>* Please Fill All Mendatory Fields</strong></h5><br>
                    <form class="col-md-6" action="<?=base_url()?>result_master/practice_test_update/<?=$answer_key->id?>" method="post" enctype='multipart/form-data'>
                        <div class="form-group">
                            <label>Class</label><span style="color:red">* <small>(for class 12th pass use 13)</small></span>
                            <input class="form-control" type="number" name="class" required="" value="<?=$answer_key->class?>">
