<div id="page-wrapper">
            ...
            <div class="row well">
                ...
                <div class="col-lg-6">
                                    <form role="form" action="<?=base_url()?>index.php/admin/edit_program/<?=$about->about_page_id?>" method="post" enctype='multipart/form-data'>
        ...
        $('#url').val(t4).text();
                                        ...
                                        <div class="form-group">
                                            ...
                                            <p class="help-block"><strong style="color: red"> * Current Image <i class="fa fa-arrow-down"></i></strong><br>
                                                <img style="width:200px" src="<?=base_url()?>images/program/<?=$about->image?>">
                                            </p><hr>
                                        </div>
