...
<div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Edit Ragistration Page</h1>
            ...
            <div class="row well">
                ...
                <div class="col-lg-6">
                                    <form role="form" action="<?=base_url()?>index.php/admin/edit_registration_page" method="post" enctype="multipart/form-data">
              <?php foreach ($reg_page->result() as $row) {
                 
              } ?> 

                                        <div class="form-group">
                                            <label>Test Syllabus Image
                                            <?=$row->test_syllabus?></label>
                                            <input type="file" name="test_syllabus">
                                            <img class="img-responsive" src="<?=base_url()?>images/registration_page/test_syllabus/<?=$row->test_syllabus?>">
                                        ...
                                        <div class="form-group">
                                            <label>Registration Information Image<?=$row->registration_info?></label>
                                            <input type="file" name="registration_info">
                                            <img class="img-responsive" src="<?=base_url()?>images/registration_page/registration_info/<?=$row->registration_info?>">
                                            <p class="help-block"></p>
                                        </div>
