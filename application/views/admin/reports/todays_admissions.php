<div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Todays Admission Report</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
...
function exportToCSV() {
    ...
    let filename = formattedDate  + '-admissions-report.csv'; // Generate filename based on current date and time
    ...
    $(document).ready(function(){
        ...
        function loadTableData() {
            ...
            var search = $('#search').val();
            $.ajax({
                url: '<?php echo base_url("Admin/load_admission_table_data"); ?>',
                type: 'post',
                data: {batch: batch, search: search,program:program,class:classs,start_date:start_date,end_date:end_date},
                success: function(response){
