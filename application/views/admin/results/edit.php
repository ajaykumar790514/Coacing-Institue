<div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Update Results</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
            ...
            <div class="row well">
                ...
                <div class="col-lg-6">
                                    <form role="form" action="<?=base_url()?>index.php/result_master/update_result/<?=$result->id?>" method="post"  enctype='multipart/form-data'>
                                           ...
                                           <select class="form-control" name="test_id" required >
                                               ...
                                               foreach ($test->result() as $test) { ?>
                                                  <option value="<?=$test->id?>"
                                                    <?php if ($test->id==$result->test_id): echo "selected"; ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input   type="text" class="form-control" name="stu_reg_number" value="<?=$result->stu_reg_number?>" readonly >
                                        ...
                                        <div class="form-group">
                                           ...
                                           <select class="form-control" name="stu_class" required >
                                               <option value="">---Select Class---</option>
                                                <option value="9"
                                         <?php  if ($result->stu_class=='9') {
                                             echo "selected"; } ?>
                                             >9<sup>th</sup></option>
                                                <option value="10"
                                                 <?php  if ($result->stu_class=='10') {
                                             echo "selected"; } ?>
                                             >10<sup>th</sup></option>
                                                <option value="11"
                                                 <?php  if ($result->stu_class=='11') {
                                             echo "selected"; } ?>
                                             >11<sup>th</sup></option>
                                                <option value="12"
                                                 <?php  if ($result->stu_class=='12') {
                                             echo "selected"; } ?>
                                             >12<sup>th</sup></option>
                                           </select>
                                        </div>
       ...
       //alert(t4);
        $('#url').val(t4).text();
                                         ...
                                         <div class="form-group">
                                            ...
                                            <input  type="text"  class="form-control" name="marks_mat" required="" value="<?=$result->marks_mat?>" >
                                            <p class="help-block"></p>
                                        </div>

                                        <div class="form-group">
                                            <label>Marks of Physics</label><span style="color:red">*</span>
                                            <input  type="text" id="marks_sat_physics"  class="form-control" name="marks_sat_physics" onkeyup="count_total()" value="<?=$result->marks_sat_physics?>" >
                                            <p class="help-block"></p>
                                        </div>

                                        <div class="form-group">
                                            <label>Marks of Chemistry</label><span style="color:red">*</span>
                                            <input  type="text"  id="marks_sat_chemistry" class="form-control" name="marks_sat_chemistry" onkeyup="count_total()" value="<?=$result->marks_sat_chemistry?>">
                                            <p class="help-block"></p>
                                        </div>

                                        <div class="form-group">
                                            <label>Marks of Math</label><span style="color:red">*</span>
                                            <input type="text" id="marks_sat_math" class="form-control" name="marks_sat_math" onkeyup="count_total()" value="<?=$result->marks_sat_math?>" >
                                            <p class="help-block"></p>
                                        </div>
<script type="text/javascript">
    function count_total() 
    {
        ...
        $("#total_marks_sat").val(total);
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" id="total_marks_sat" type="text" name="marks_sat" required readonly value="<?=$result->marks_sat?>" >
                                            <p class="help-block"></p>
                                        </div>

                                         <div class="form-group">
                                            <label>Waiver Offered</label><span style="color:red">*</span>
                                            <input type="text"  class="form-control" name="waiver_offered"  value="<?=$result->waiver_offered?>">
                                            <p class="help-block"></p>
                                        </div>

                                        <div class="form-group">
                                            <label>Valid Upto</label>
                                            <input type="date"  class="form-control" name="valid_upto" value="<?=$result->valid_upto?>" >
                                            <p class="help-block"></p>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea rows="3"  class="form-control" name="disclaimer" ><?=$result->disclaimer?></textarea>
                                            <p class="help-block"></p>
                                        </div>
