<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Update Result Pdf</h1>
        </div>
    </div>
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <h5 style="color:red;"><strong>* Please Fill All Mendatory Fields</strong></h5><br>
                    <form class="col-md-6" action="<?=base_url()?>result_master/result_pdf_update/<?=$result_pdf->id?>" method="post" enctype='multipart/form-data'>
                        <div class="form-group">
                            <label>Class</label><span style="color:red">*</span>
                            <input class="form-control" name="class" required="" value="<?=$result_pdf->class?>">
                            <p class="help-block"></p>
                        </div>

                         <div class="form-group">
                            <label>Batch Name</label><span style="color:red">*</span>
                            <input class="form-control" name="batch_name" required="" value="<?=$result_pdf->batch_name?>">
                            <p class="help-block"></p>
                        </div>

                        <div class="form-group">
                            <label>Test Date</label><span style="color:red">*</span>
                            <input type="date" class="form-control" name="test_date" required="" value="<?=$result_pdf->test_date?>">
                            <p class="help-block"></p>
                        </div>
                         ...
                         <div class="form-group">
                            ...
                            <input type="number" class="form-control" name="pdf_order" required="" value="<?=$result_pdf->pdf_order?>">
                            <p class="help-block"></p>
                        </div>
