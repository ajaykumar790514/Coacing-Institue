        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <h5 style="color:red;"><strong>* Please Fill All Mendatory Fields</strong></h5><br>
                    <form class="col-md-6" action="<?=base_url()?>main_controller/update_role/<?=$role_data->id?>" method="post" enctype='multipart/form-data'>
                        <div class="form-group">
                            <label>Title</label><span style="color:red">*</span>
                            <input class="form-control" name="title" required="" value="<?=$role_data->title?>">
...
<style type="text/css">
    ...
    .pointer
    {
        cursor: pointer;
                        ...
                        <div class="form-group" >
                            <label><h4>Select Parent Menu</h4></label>
                            <table class="table">
                                <tbody>
