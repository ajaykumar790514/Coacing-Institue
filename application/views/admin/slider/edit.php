<div id="page-wrapper">
            ...
            <div class="row well">
                ...
                <div class="col-lg-6">
                                    <form role="form" action="<?=base_url()?>index.php/admin/edit_slide/<?=$slide->id?>" method="post" enctype='multipart/form-data'>
                                        <div class="form-group">
                                            <label>Slide Name</label><span style="color:red">*</span>
                                            <input class="form-control" name="name" required="" value="<?=$slide->name?>">
                                            <p class="help-block"></p>
                                        </div>

                                        <div class="form-group">
                                            <label>Description</label>
                                            <textarea id="markItUp" rows="8" class="form-control" name="description"><?=$slide->description?></textarea>
                                            <p class="help-block"></p>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <p class="help-block"><strong style="color: red"> * Current Slide Image <i class="fa fa-arrow-down"></i></strong><br>
                                                <img style="width:200px" src="<?=base_url()?>images/slider/<?=$slide->img?>">
                                            </p><hr>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input required="" type="number" class="form-control" name="slide_order" value="<?=$slide->slide_order?>">
                                            <p class="help-block"></p>
                                        </div>
