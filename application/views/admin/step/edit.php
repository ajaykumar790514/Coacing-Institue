<div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Edit Step</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
            ...
            <div class="row well">
                ...
                <div class="col-lg-6">
                                    <form role="form" action="<?=base_url()?>index.php/admin/edit_step/<?=$step->id?>" method="post">
                                        
                                        <div class="form-group">
                                            <label>Name</label>
                                            <input value="<?=$step->step_name?>"  class="form-control" name="step_name" >
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea  rows="2" class="form-control" name="description" ><?=$step->description?></textarea>
                                            <p class="help-block"></p>
