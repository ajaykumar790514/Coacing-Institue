<div id="page-wrapper">
            ...
            <div class="row well">
                ...
                <div class="col-lg-6">
                                    <form role="form" action="<?=base_url()?>index.php/admin/add_testimonial" method="post"  enctype='multipart/form-data'>
                                        ...
                                        <div class="form-group"> 
                                            ...
                                            <textarea id="" rows="8" class="form-control" name="description" onchange="extract_keywords()"  onkeyup="countChar1(this)"></textarea>
                                            <p class="help-block"></p>
     ...
     if (len >= 184) {
              ...
              $('#charNum1').text(184 - len +' characters left');
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="meta_title" onkeyup="countChar(this)">
                                            <p class="help-block"></p>
                                        </div>
<script type="text/javascript">
