<div id="page-wrapper">
            ...
            <?php endif;?>
                                    ...
                                    <a class="btn btn-warning" style="float:right" href="<?=base_url()?>index.php/admin/add_testimonial">Add <i class="fa fa-plus"></i></a>
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
                                    <?php $i=1; foreach($updates->result() as $product){ ?>
                                    <tr class="">
                                        <td><?=$i?></td>
                                        <td><?=$product->title?></td>
                                        <td><?=$product->name?></td>
                                        <td><img style="width: 100px" src="<?=base_url()?>images/testimonial/<?=$product->img?>"></td>
                                        ...
                                        <td>
                                            <a href="<?=base_url()?>index.php/admin/edit_testimonial/<?=$product->id?>" class="btn btn-warning" title="EDIT">
        ...
        <script type="text/javascript">
            ...
            function activate_inactive(id,status)
            {
                ...
                $("#active_status"+id).load('<?=base_url()?>index.php/admin/active_inactive_testimonial/'+id+'/'+status);
            }
        </script>
