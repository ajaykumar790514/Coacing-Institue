<div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Edit Update</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
            ...
            <?php endif;?>
                                    <br />
                                    <?php if($update->language=='en'){ ?>
	                                    <div class="form-group col-md-12 col-sm-12 col-xs-12"><hr>
	                                            <a style="float:right;margin-left: 10px" class="btn btn-warning" href="<?=base_url()?>index.php/admin/edit_update/<?=$update->update_id?>/ru">RUSSIAN</a>
	                                            <a style="float:right;margin-left: 10px" class="btn btn-warning" href="<?=base_url()?>index.php/admin/edit_update/<?=$update->update_id?>/fr">FRENCH</a>
	                                    </div>
                                	<?php }else{ ?>
                                		<div class="form-group col-md-12 col-sm-12 col-xs-12"><hr>
	                                            <a style="float:right;margin-left: 10px" class="btn btn-warning" href="<?=base_url()?>index.php/admin/edit_update/<?=$update->update_id?>">ENGLISH</a>
	                                    </div>
	                                <?php } ?>
            ...
            <div class="row well">
                ...
                <div class="col-lg-6">
                                    <form role="form" action="<?=base_url()?>index.php/admin/edit_update/<?=$update->update_id?>" method="post" enctype='multipart/form-data'>
                                        <div class="form-group">
                                            <label>Title</label><span style="color:red">*</span>
                                            <input class="form-control" name="title" required="" value="<?=$update->title?>" onchange="cr_url(this.value)">
       ...
       //alert(t4);
        $('#url').val(t4).text();
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea id="" rows="8" class="form-control" name="description"><?=$update->description?></textarea>
                                            <p class="help-block"></p>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <p class="help-block"><strong style="color: red"> * Current Image <i class="fa fa-arrow-down"></i></strong><br>
                                                <img style="width:200px" src="<?=base_url()?>images/updates/<?=$update->img?>">
                                            </p><hr>
                                        </div>
                                         ...
                                         <div class="form-group">
                                            ...
                                            <input class="form-control" name="img_alt" required="" value="<?=$update->img_alt?>">
                                            <p class="help-block"></p>
                                        </div>

                                        <div class="form-group">
                                            <label>Image Title</label><span style="color:red">*</span>
                                            <input class="form-control" name="img_title" required="" value="<?=$update->img_title?>">
                                            <p class="help-block"></p>
                                        </div>

                                        <div class="form-group">
                                            <label>Meta Title</label> <span style="color:red">*</span> <span id="charNum"></span>
                                            <input class="form-control" name="meta_title" value="<?=$update->meta_title?>"
     ...
     if (len >= 70) {
              ...
              $('#charNum').text(70 - len +' characters left');
                                        ...
                                        <?php if($update->language=='en'){ ?>
	                                        ...
	                                        <div class="form-group well" style="background-color: white">
	                                            <label>Select a language you want to convert</label><br>
	                                            <input type="checkbox" name="language[]" value="ru"> RUSSIAN <br>
	                                            <input type="checkbox" name="language[]" value="fr"> FRENCH <br>
	                                            <input type="checkbox" name="language[]" value="hi"> HINDI <br>
	                                            <p class="help-block"></p>
	                                        </div>
                                    	<?php } ?>

                                          <div class="form-group">
                                            <label>Wallpost Url<span style="color:red">*</span> <br>
                                                <span id="url_span">
                                                    <?=base_url()?>index.php/welcome/update_details/<?=$update->url?>/<?=$update->id?>
                                                </span>
                                            </label>
                                            <input  id="url" required="" class="form-control" onchange="change_url()" name="url"  value="<?=$update->url?>" readonly>
                                            <p class="help-block"></p>
                                        </div>
                                        ...
                                        <script type="text/javascript">
                                            function change_url()
                                            {
                                                ...
                                                $("#url_span").html('<?=base_url()?>index.php/welcome/update_details/'+url+'/<?=$update->id?>');
                                            }
                                        </script>
