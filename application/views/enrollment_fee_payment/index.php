			...
			<center>
				  <div class="form-inline">
				    <div class="form-group">
				      ...
				      <input type="text" class="form-control" id="enroll_no" placeholder="Enter Enrollment No." name="enroll_no">
				    </div>
...
<script type="text/javascript">
	$(document).ready(function(){
		$('#get_fees').click(function(){
			...
			$('#fees_deteils').load('<?=base_url()?>enrollment_fee_payment/check_fee/'+enroll_no);
		})
