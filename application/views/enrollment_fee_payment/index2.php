...
<html>
<head>
	<title>Jee Expert Enrollment Fee</title>
	<meta charset="utf-8">
    <meta name="Description" CONTENT="Jee Expert Enrollment Fee. Enrollment-Fee-Payment  ">
			...
			<center>
				  <div class="form-inline">
				    <div class="form-group">
				      ...
				      <input type="text" class="form-control" id="enroll_no" placeholder="Enter Enrollment No." name="enroll_no" value="ANKITV4087">
				    </div>
...
<script type="text/javascript">
	$(document).ready(function(){
		$('#get_fees').click(function(){
			...
			if(enroll_no == ''){ $('#enroll_no').focus();
			return false; }

			$('#fees_deteils').html('Loading...');
			$('#fees_deteils').load('<?=base_url()?>enrollment_fee_payment/check_fee_test/'+enroll_no);
		})
