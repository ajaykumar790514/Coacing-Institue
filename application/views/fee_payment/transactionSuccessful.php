...
<html>
<head>
	<title>Jee-Expert-Registration-Fee-<?=$stu_data->registration_no?>-<?=$transaction_data['transaction_id']?>-<?=$transaction_data['transaction_status']?></title>
	<meta charset="utf-8">
    <meta name="Description" CONTENT="Jee Expert Registration Fee.">
				...
				<table class="table table-bordered table-striped table-hover">
				    <tbody>
				      ...
				      <tr>
				        ...
				        <td><?=$stu_data->registration_no?></td>
				        <input type="hidden" name="registration_no" value="<?=$stu_data->registration_no?>">
				      </tr>

				      <tr>
				        <th>Student Name</th>
				        <td><?=$stu_data->student_name?></td>
				      </tr>
