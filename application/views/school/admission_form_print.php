    ...
    <div class="container container_inner">
        <div class="row">
			...
			<div class="col-md-12 text-center">
				<strong class="heading"><u>REGISTRATION FORM FOR SCHOLARSHIP COM ADMISSION TEST</u></strong>
				<br>
				<br>
			</div>
		...
		<div class="col-md-9">
			<div class="form-group">
				<div class="form-row">
					<div class="col-md-12">
					    ...
					    <input class="form-control" id="name_student" type="text" aria-describedby="namestudent" placeholder="Enter name student" required="" name="student_name">
					  </div>
					</div>
				</div>
			</div>
			...
			<div class="form-group">
				<div class="form-row">
					<div class="col-md-12">
					  ...
					  <input class="form-control" id="date" type="date" aria-describedby="date" placeholder="Enter dob" required="" name="dob">
					  </div>
					</div>
				</div>
			</div>
			...
			<div class="form-group">
				<div class="form-row">
					<div class="col-md-12">
					  ...
					  <input class="form-control" id="" type="text"  placeholder="Enter nationality"  name="nationality">
					  </div>
					</div>
				</div>
			</div>
			...
			<div class="form-group">
				<div class="form-row">
					...
					<div class="col-md-4">
					  ...
					  <input class="form-control"  type="text" aria-describedby="c_g_p_a" placeholder="Enter C.G.P.A"  name="c_g_p_a">
					  </div>
					</div>
				</div>
			</div>
		  	...
		  	<div class="form-group">
				<div class="form-row">
					<div class="col-md-7">
					  ...
					  <input class="form-control" type="text"  placeholder="Enter Aadhar Number" required="" name="adhar_number">
					  </div>
					</div>
					<!-- <div class="col-md-5">
						<div class="input-group">
			...
			<div class="form-group">
				<div class="form-row">
					<div class="col-md-6">
						<div class="input-group">
					    <span class="input-group-addon" style="color:darkblue;"><b>i) Board :</b></span>
					  <input class="form-control" id="" type="text"  placeholder="Board" name="board">
					  </div>
					</div>
				</div>
			</div>
		...
		<div class="form-group">
				<div class="form-row">
					<div class="col-md-6">
					  ...
					  <input class="form-control" id="" type="date"  placeholder="Admission Test Date" required="" name="admission_test_date">
					  </div>
					</div>
				</div>
			</div>
			...
			<div class="form-group">
				<div class="form-row">
					<div class="col-md-6">
					  ...
					  <input class="form-control" id="" type="text"  placeholder="Centre Code" name="center_code">
					  </div>
					</div>
				</div>
			</div>
			...
			<div class="form-group">
				<div class="form-row">
					<div class="col-md-6">
					  ...
					  <input class="form-control" id="" type="text"  placeholder="Present Class"  name="present_class">
			...
			<div class="form-group">
				<div class="form-row">
					<div class="col-md-6">
					  ...
					  <input class="form-control" id="" type="text"  placeholder="Program Code" name="program_code">
					  </div>
					</div>
				</div>
			</div>
	...
	<h4 style="color:red;">3. Communication Details</h4>
		...
		<div class="form-group">
			<div class="form-row">
				...
				<div class="col-md-5">
					<div class="input-group">
				  <input class="form-control" type="number"  placeholder="Enter PIN" required="" name="pin">
				  </div>
				</div>
			</div>
		</div>
...
<div class="col-md-12">
				<div class="row">
				<h4 style="color:red;">3. Parent’s Details</h4>
					<div class="col-md-12 ">
					    <div class="form-group">
							<div class="form-row">
							<table class="table table-bordered  ">
                                   ...
                                   <tbody>
                                        <tr class="table-info">
                                            ...
                                            <td>
                                            	<input class="form-control" type="text" name="father_name" placeholder="Enter Here" required="">
                                            </td>
                                            <td>
                                            	<input class="form-control" type="text" name="mother_name" placeholder="Enter Here" required="">
                                            </td>
                                        </tr>
										<tr>
										...
										<tr class="table-info" >
                                           ...
                                           <td>
                                           		<input class="form-control" type="text" name="father_occupation" placeholder="Enter Here" required="">
                                           </td>
                                           <td>
                                           		<input class="form-control" type="text" name="mother_occupation" placeholder="Enter Here" required="">
                                           </td>
                                        </tr>
										<tr>
                                           <td style="color:darkblue;" >Organization Name</td>
                                           <td>
                                           		<input class="form-control" type="text" name="father_organization" placeholder="Enter Here">
                                           </td>
                                           <td>
                                           		<input class="form-control" type="text" name="mother_organization" placeholder="Enter Here">
                                           </td>
                                        </tr>
										<tr class="table-info">
                                           <td style="color:darkblue;">Designation in Organization</td>
                                           <td>
                                           		<input class="form-control" type="text" name="father_designation_in_organization" placeholder="Enter Here">
                                           </td>
                                           <td>
                                           		<input class="form-control" type="text" name="mother_designation_in_organization" placeholder="Enter Here">
                                           </td>
                                        </tr>
										<tr>
						...
						<div class="row">
							<div class="col-md-12">
								<div class="form-group">
									<div class="form-row">
										<div class="col-md-12">
											<h4 style="color:red;">8. Declaration by Parent/Student/Guardian</h4>
